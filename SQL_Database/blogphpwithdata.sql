...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 02 fév. 2024 à 10:12
...
INSERT INTO `commentaire` (`id`, `created_at`, `updated_at`, `content`, `id_User`, `id_Post`) VALUES
...
(8, '2024-02-01', '2024-02-02', 'C\'est exactement ce que je cherchais.', 1, 1),
...
INSERT INTO `formulaire_contact` (`id`, `email`, `firstname`, `lastname`, `message`, `send_at`) VALUES
...
INSERT INTO `post` (`id`, `title`, `chapo`, `content`, `created_at`, `updated_at`, `id_Category`, `id_User`) VALUES
...
(5, 'michael.brown@example.com', 'MichaelBrown', 'mdp3456', '', 'Michael', 'Brown', 'subscriber'),
